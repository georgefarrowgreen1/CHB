...
// ============================================================
const CACHE = 'chb-cache-v58';
const CORE = ['./', 'index.html', 'logo.svg', 'favicon.png', 'apple-touch-icon.png', 'manifest.json', 'app.css?v=17', 'app.js?v=28', 'guest-app.css?v=17', 'guest-app.js?v=11'];
