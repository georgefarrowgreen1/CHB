...
const CORE = ['./', 'index.html', 'logo.svg', 'favicon.png', 'apple-touch-icon.png', 'manifest.json', 'app.css?v=123', 'app.js?v=221', 'guest-app.css?v=28', 'guest-app.js?v=15'];
